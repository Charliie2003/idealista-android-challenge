...
**Requirements:** Android Studio Meerkat or later, JDK 17, Android SDK 36.1.
...
Eight production modules plus the shared `:core:testing` test-fixtures module, with strictly defined
...
| # | Title | Status |
|---|---|---|
| [0001](docs/adr/0001-modularization-strategy.md) | Modularization strategy — 8 modules, `:core:data` as aggregation layer | Accepted |
